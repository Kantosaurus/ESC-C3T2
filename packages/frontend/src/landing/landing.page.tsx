        ...
        <div className="container relative mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            <motion.div
              ...
              <h1 className="text-5xl font-light tracking-tight text-gray-900 dark:text-white sm:text-7xl whitespace-nowrap flex flex-row items-center gap-2">
                Care{" "}
                <PointerHighlight>
                  <span>Smarter</span>
                </PointerHighlight>
              ...
              <p className="mt-8 text-lg leading-8 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                The all-in-one platform for caregivers. Coordinate care, manage
                appointments, and access resources - all in one place.
              </p>
